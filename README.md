...
- **[Personal Data Engine](https://github.com/jwalin-shah/data-connect-framework)** — Privacy-first knowledge graph for personal context. Schema-driven ingestion pipelines (JSONL/NDJSON → SQLite + sqlite-vec), local SLM reasoning (Qwen family), staged multimodal memory architecture for constrained hardware.
